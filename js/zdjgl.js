...
layui.use(['table', 'form'], function () {
    ...
    table.render({
        ...
        , page: true //开启分页
        , cols: [[ //表头
            {field: 'name', title: '分布区域', rowspan: 3},
            {field: 'name', title: '参考区域', rowspan: 3},
            {field: 'name', title: '最低价格（元/M²/月）', colspan: 4,},
            , {title: '操作', toolbar: '#barDemo', width: 200}
        ], [
            {field: 'name', title: '写字楼',rowspan: 3},
            {field: 'name', title: '店面房',rowspan: 3},
            {field: 'name', title: '标准厂房',colspan: 2},
