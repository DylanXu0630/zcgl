...
;layui.define(["laytpl", "laypage", "layer", "form", "util"], function (e) {
    ...
    I.prototype.config = {
        ...
        var e, a = this, o = a.config, c = t("body"), s = {}, u = a.layHeader.find("th"), h = ".layui-table-cell", p = o.elem.attr("lay-filter");
        ...
        var v = function (e) {
            var l = t(this), n = l.parents("tr").eq(0).data("index"), o = a.layBody.find('tr[data-index="' + n + '"]'), r = d.cache[a.key] || [];
        ...
        a.layBody.on("change", "." + W, function () {
            ...
            var e, l = t(this), n = this, o = l.parent().data("field"), r = l.parents("tr").eq(0).data("index"), c = d.cache[a.key][r];
